...
class DeformableBodyAttachmentsDemo(demo.Base):
    ...
    def create(self, stage):
        ...
        room = demo.get_demo_room(self, stage, zoom = 0.8, hasTable = False)
        ...
        deformableUtils.add_physx_deformable_body(stage, blob_left_mesh.GetPath(),
            collision_simplification=False, simulation_hexahedral_resolution=15)
        ...
        deformableUtils.add_physx_deformable_body(stage, blob_right_mesh.GetPath(),
            collision_simplification=False, simulation_hexahedral_resolution=15)
        ...
        deformableUtils.add_physx_deformable_body(stage, blob_horizontal_mesh.GetPath(),
            collision_simplification=False, simulation_hexahedral_resolution=15)
