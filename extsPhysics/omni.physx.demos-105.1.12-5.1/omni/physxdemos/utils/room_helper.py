...
class RoomHelper():
    ...
    def __init__(
        ...
        self._sphereLight, self._targetLightPos = RoomHelper.get_lights(self._stage, self._defaultPrimPath, demoInstance, self._isMuseum, self._scaleFactor, self._enableDefaultLighting, targetLightPos)
    ...
    @staticmethod
    def get_lights(stage, defaultPrimPath, demoInstance, isMuseum, scaleFactor, createLights, targetLightPos):
    ...
    def setup_collision_audio(self, stage, materialName, materialData):
        ...
        audioBaseDir = os.path.abspath(os.path.normpath(os.path.join(__file__, "../../../../data/audio")))
