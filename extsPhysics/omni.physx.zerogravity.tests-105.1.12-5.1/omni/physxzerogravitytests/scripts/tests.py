...
from omni.physxzerogravity.scripts.utils import is_kit_vp2
...
class ZeroGravityTests(PhysicsKitStageAsyncTestCase):
    ...
    @unittest.skipUnless(is_kit_vp2(), 'Kit VP2 is required')
    async def test_manipulator(self):
        ...
        hides when scale mode is active. This test is for Kit VP2 only.'''
