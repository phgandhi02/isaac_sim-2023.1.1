...
class PhysicsPreferences(PreferenceBuilder):
    ...
    def _build_local_mesh_cache_ui(self):
        self._line_height = 23
        self._add_setting(SettingType.BOOL, "Enable Local Mesh Cache", physx_bindings.SETTING_USE_LOCAL_MESH_CACHE)
        self._add_setting(SettingType.INT, "Local Mesh Cache Size MB", physx_bindings.SETTING_LOCAL_MESH_CACHE_SIZE_MB, 16, 4096)
