...
class CollisionGroupsWindow:
    ...
    def on_startup(self):
        ...
        self._menu_path = f"Window/Physics/{self.WINDOW_NAME}"
        self._menu = omni.kit.ui.get_editor_menu().add_item(self._menu_path, self._on_main_menu_click, toggle=True)
    ...
    def _on_main_menu_click(self, menu, toggled):
        self._settings.set_bool(pb.SETTING_SHOW_COLLISION_GROUPS_WINDOW, toggled)
