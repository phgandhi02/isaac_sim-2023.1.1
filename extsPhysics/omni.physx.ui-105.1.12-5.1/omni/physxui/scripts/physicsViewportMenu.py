        ...
        def _build_menu():
            ...
            def create_menu_sim_output_bool_item(text, setting) -> CategoryStateItem:
                def show_overlay(model, item):
                    ...
                    if self._simulationInfoWnd is None:
                        self._simulationInfoWnd = SimulationInfoWindow() 
                        self._simulationInfoWnd.set_pos(55, 100)
                    if show:
                        self._simulationInfoWnd.show()
                    else:
                        self._simulationInfoWnd.hide()
