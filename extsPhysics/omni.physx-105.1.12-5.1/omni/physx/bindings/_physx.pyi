...
__all__ = [
    ...
    "SETTING_UPDATE_FORCE_SENSORS_TO_USD",
    "SETTING_UPDATE_FORCE_SENSORS_TO_USD_DEFAULT",
...
class PhysXUnitTests():
    ...
    """
    def end_check_for_error(self) -> bool: ...
    ...
    def start_check_for_error(self, arg0: str) -> None: ...
    ...
    def set_visualization_parameter(self, debug_vis: str, enable: bool) -> None: 
        ...
        Args:
            debug_vis - Debug visualization feature string identifier, can be one of the following:
                ...
                'ContactNormal', 'ContactError', 'ContactForce', 'ActorAxes', 'CollisionAABBs', 'CollisionShapes',
                'CollisionAxes', 'CollisionCompounds', 'CollisionEdges', 'CollisionStaticPruner',
                'CollisionDynamicPruner', 'JointLocalFrames', 'JointLimits', 'CullBox', 'MBPRegions'}
...
def hasconflictingapis_PhysxParticleSamplingAPI(arg0: UsdPrim, arg1: bool) -> bool:
    pass
def hasconflictingapis_Precompute(arg0: UsdPrim) -> typing.List[bool[3]]:
    pass
...
SETTING_UPDATE_FORCE_SENSORS_TO_USD = '/physics/updateForceSensorsToUsd'
SETTING_UPDATE_FORCE_SENSORS_TO_USD_DEFAULT = '/defaults/physics/updateForceSensorsToUsd'
