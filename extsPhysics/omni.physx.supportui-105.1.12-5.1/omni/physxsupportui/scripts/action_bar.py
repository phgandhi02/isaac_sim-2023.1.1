...
from .utils import is_kit_vp2, ui_wait, get_physics_physx_schemas_applied
...
class ButtonDef:
    ...
    @staticmethod
    def define_buttons(button_defs_dict: Dict[str, Any], icon_folder: str):
        def def_button(
            key: str,
            ui_text: str,
            icon_name: str,
        ...
        def_button(ButtonDef.BUTTON_RB_SEL, "RB Selecton", "rigid_body_selection_mode.svg", "Rigid Body Selection Mode")
        def_button(ButtonDef.BUTTON_CLEAR, "Clear", "remove_physics_components.svg", "Remove Physics")
        def_button(ButtonDef.BUTTON_STATIC, "Static", "set_static.svg", "Set Static Collider")
        def_button(ButtonDef.BUTTON_DYNAMIC, "Dynamic", "set_dynamic.svg", "Set Dynamic Collider")
        def_button(ButtonDef.BUTTON_AUTO_COLL, "AutoColl", "collision_automatic_creation_static.svg", "Automatic Collider Generation")
        def_button(ButtonDef.BUTTON_MASS, "Mass", "mass_manipulator.svg", "Mass Distribution Manipulator")
        def_button(ButtonDef.BUTTON_SETTINGS, "Settings", "physics_settings.svg", "Settings")
...
class ActionBar:
    def __init__(self, icon_folder, support_ui_iface):
        ...
        if not is_kit_vp2():
            self._settings.set_bool(pxsupportui.SETTINGS_CUSTOM_MANIPULATOR_ENABLED, False)
