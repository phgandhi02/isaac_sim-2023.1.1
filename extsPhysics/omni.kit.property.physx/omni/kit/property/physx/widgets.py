...
from .externals import UsdBindingAttributeWidget, Prompt
            ...
            with ui.ZStack():
                ...
                with ui.HStack():
                    ...
                    with ui.VStack(width=0):
                        ui.Spacer(height=5)
                        ui.Button(style=REMOVE_BUTTON_STYLE, height=16, width=16).set_mouse_pressed_fn(on_remove_clicked_mouse)
                    ui.Spacer(width=5)
                ...
                with ui.HStack():
                    ...
                    if component is not None:
                        def on_remove_clicked():
                            ...
                            self._remove_prompt_check(component.title, on_yes)
                        ui.Button(style=REMOVE_BUTTON_STYLE, clicked_fn=on_remove_clicked, width=16)
...
class PhysicsMaterialBindingWidget(UsdBindingAttributeWidget):
    ...
    def __init__(self):
        super().__init__(
            lambda p: p.IsA(UsdShade.Material) and database.has_any_material_api(p) and not omni.usd.is_hidden_type(p),
