...
property_info = {
    ...
    "physxPBDMaterial:cflCoefficient": InfoData(1, Limits.FLT_MAX),
...
def generate_order():
    ...
    for name in names:
        path = f"{name}/resources/{name}/schema.usda"
        path = carb.tokens.get_tokens_interface().resolve("${kit}/../../../target-deps/usd_ext_physics/release/share/usd/plugins/" + path)
...
default_order_map = {
    ...
    PhysxSchema.PhysxMaterialAPI: ['physxMaterial:frictionCombineMode', 'physxMaterial:restitutionCombineMode', 'physxMaterial:improvePatchFriction', 'physxMaterial:compliantContactStiffness', 'physxMaterial:compliantContactDamping'],
    ...
    PhysxSchema.PhysxParticleSystem: ['particleSystemEnabled', 'enableCCD', 'contactOffset', 'restOffset', 'particleContactOffset', 'solidRestOffset', 'fluidRestOffset', 'solverPositionIterationCount', 'solverVelocityIterationCount', 'maxVelocity', 'maxDepenetrationVelocity', 'enableCCD', 'wind', 'maxNeighborhood'],
