...
class ButtonDef:
    ...
    def define_buttons(button_defs_dict: Dict[str, Any], icon_folder: str):
        ...
        def_button(ButtonDef.BUTTON_CLEAR, "marker_clear.svg", "Clear Markers")
        def_button(ButtonDef.BUTTON_STATIC, "marker_static_1_menu.svg", "Mark Static")
        def_button(ButtonDef.BUTTON_STATIC2, "marker_static_2_menu.svg", "Mark Static")
        def_button(ButtonDef.BUTTON_DYNAMIC, "marker_dynamic_1_menu.svg", "Mark Dynamic")
        def_button(ButtonDef.BUTTON_DYNAMIC2, "marker_dynamic_2_menu.svg", "Mark Dynamic")
        def_button(ButtonDef.BUTTON_DROP_START, "drop_start.svg", "Start Dropping Selected Assets (<END> key)")
        def_button(ButtonDef.BUTTON_DROP_STOP, "drop_stop.svg", "Stop Dropping Selected Assets (<END> key)")
        def_button(ButtonDef.BUTTON_SWEEP_START, "sweep_start.svg", "Start Sweep Mode")
        def_button(ButtonDef.BUTTON_SWEEP_STOP, "sweep_stop.svg", "Stop Sweep Mode")
        def_button(ButtonDef.BUTTON_SETTINGS, "settings_menu.svg", "Settings")
