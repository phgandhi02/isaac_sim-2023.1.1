...
class Runner(ABC):
    ...
    def push_stage_runtime_settings(self, sim_params, sync_params):
        ...
        self.saved_update_force_sensors_to_usd = settings.get_as_bool(physx_bindings.SETTING_UPDATE_FORCE_SENSORS_TO_USD)
        if sync_params.sync_usd:
            ...
            settings.set(physx_bindings.SETTING_UPDATE_FORCE_SENSORS_TO_USD, not sync_params.transforms_only)
        else:
            ...
            settings.set(physx_bindings.SETTING_UPDATE_FORCE_SENSORS_TO_USD, False)
    ...
    def pop_stage_runtime_settings(self):
        ...
        if hasattr(self, "saved_update_force_sensors_to_usd"):
            settings.set(physx_bindings.SETTING_UPDATE_FORCE_SENSORS_TO_USD, self.saved_update_force_sensors_to_usd)
