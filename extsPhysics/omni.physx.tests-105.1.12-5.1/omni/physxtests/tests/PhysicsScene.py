...
class PhysicsSceneTestMemoryStage(PhysicsMemoryStageBaseAsyncTestCase):
    ...
    @unittest.skip("Expect multimsg not supported on 105.1")
    ...
    async def test_multi_sim_joints_different_owners(self):
        ...
        message = f"Cannot create joint between bodies that belong to different owners. Joint: /World/fixedJoint0"
