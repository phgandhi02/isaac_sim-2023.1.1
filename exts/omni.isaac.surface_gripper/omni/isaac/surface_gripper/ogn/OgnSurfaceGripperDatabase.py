...
class OgnSurfaceGripperDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('inputs:GripPosition', 'target', 0, None, 'The point at which objects will be gripped', {}, True, [], False, ''),
        ...
        ('inputs:ParentRigidBody', 'target', 0, None, 'The rigid body that is used as a surface Gripper', {}, True, [], False, ''),
    ...
    class abi:
        ...
        def release_instance(node, target):
            OgnSurfaceGripperDatabase._release_per_node_instance_data(node, target)
