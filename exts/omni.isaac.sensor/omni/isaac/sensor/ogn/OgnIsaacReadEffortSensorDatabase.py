...
class OgnIsaacReadEffortSensorDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('inputs:prim', 'target', 0, 'Prim Path', 'Path to the joint getting measured', {}, True, [], False, ''),
    ...
    class abi:
        ...
        def release_instance(node, target):
            OgnIsaacReadEffortSensorDatabase._release_per_node_instance_data(node, target)
