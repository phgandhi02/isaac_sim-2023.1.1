...
class OgnIsaacReadCameraInfoDatabase(og.Database):
    ...
    Attribute Value Properties:
        ...
        Outputs:
            ...
            outputs.physicalDistortionCoefficients
            outputs.physicalDistortionModel
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('outputs:focalLength', 'float', 0, None, 'focal length', {}, True, None, False, ''),
        ('outputs:height', 'uint', 0, None, 'Height for output image', {}, True, None, False, ''),
        ('outputs:horizontalAperture', 'float', 0, None, 'horizontal aperture', {}, True, None, False, ''),
        ('outputs:horizontalOffset', 'float', 0, None, 'horizontal offset', {}, True, None, False, ''),
        ('outputs:physicalDistortionCoefficients', 'float[]', 0, None, 'physical distortion model used for approximation, empty if not specified on camera prim', {}, True, None, False, ''),
        ('outputs:physicalDistortionModel', 'token', 0, None, 'physical distortion model used for approximation, empty if not specified on camera prim', {}, True, None, False, ''),
        ('outputs:projectionType', 'token', 0, None, 'projection type', {}, True, None, False, ''),
        ('outputs:verticalAperture', 'float', 0, None, 'vertical aperture', {}, True, None, False, ''),
        ('outputs:verticalOffset', 'float', 0, None, 'vertical offset', {}, True, None, False, ''),
    ...
    class ValuesForOutputs(og.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES = {"focalLength", "height", "horizontalAperture", "horizontalOffset", "physicalDistortionModel", "projectionType", "verticalAperture", "verticalOffset", "width", "_batchedWriteValues"}
        ...
        def __init__(self, node: og.Node, attributes, dynamic_attributes: og.DynamicAttributeInterface):
            ...
            self.physicalDistortionCoefficients_size = None
        ...
        def physicalDistortionCoefficients(self):
            ...
            return data_view.get(reserved_element_count=self.physicalDistortionCoefficients_size)
        ...
        def physicalDistortionModel(self):
            value = self._batchedWriteValues.get(self._attributes.physicalDistortionModel)
            if value:
                return value
            else:
        ...
        def physicalDistortionModel(self, value):
            self._batchedWriteValues[self._attributes.physicalDistortionModel] = value
    ...
    class abi:
        ...
        def release_instance(node, target):
            OgnIsaacReadCameraInfoDatabase._release_per_node_instance_data(node, target)
