...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.ros2_bridge.ogn.OgnROS2PublishAckermannDatabase import OgnROS2PublishAckermannDatabase
        ...
        database = OgnROS2PublishAckermannDatabase(test_node)
