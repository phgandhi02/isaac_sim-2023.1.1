...
class TestOgn(ogts.OmniGraphTestCase):
    ...
    async def test_data_access(self):
        from omni.isaac.debug_draw.ogn.OgnIsaacXPrimAxisVisualizerDatabase import OgnIsaacXPrimAxisVisualizerDatabase
        ...
        database = OgnIsaacXPrimAxisVisualizerDatabase(test_node)
        ...
        db_value = database.inputs.length
        expected_value = 1
