...
class OgnQuinticPathPlannerDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('inputs:targetPrim', 'target', 0, None, 'USD prim reference to the goal position/orientation prim', {}, False, [], False, ''),
    ...
    class abi:
        ...
        def release_instance(node, target):
            OgnQuinticPathPlannerDatabase._release_per_node_instance_data(node, target)
