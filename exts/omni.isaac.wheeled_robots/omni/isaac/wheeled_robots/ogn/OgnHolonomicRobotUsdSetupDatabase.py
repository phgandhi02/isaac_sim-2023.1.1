...
class OgnHolonomicRobotUsdSetupDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ('inputs:comPrim', 'target', 0, None, 'prim for the center of mass xform', {}, True, [], False, ''),
        ('inputs:comPrimPath', 'token', 0, None, "prim path to the robot's center of mass xform", {}, True, "", False, ''),
        ('inputs:robotPrim', 'target', 0, None, "prim for the robot's articulation root", {}, True, [], False, ''),
    ...
    class abi:
        ...
        def release_instance(node, target):
            OgnHolonomicRobotUsdSetupDatabase._release_per_node_instance_data(node, target)
