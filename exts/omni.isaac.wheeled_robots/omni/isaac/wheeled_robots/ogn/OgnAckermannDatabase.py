...
class OgnAckermannDatabase(og.Database):
    ...
    INTERFACE = og.Database._get_interface([
        ...
        ('outputs:leftWheelAngle', 'double', 0, None, 'Angle for the left turning wheel in degrees', {}, True, None, False, ''),
        ('outputs:rightWheelAngle', 'double', 0, None, 'Angle for the right turning wheel in degrees', {}, True, None, False, ''),
    ...
    class abi:
        ...
        def release_instance(node, target):
            OgnAckermannDatabase._release_per_node_instance_data(node, target)
        ...
        def initialize_type(node_type):
            ...
            if needs_initializing:
                ...
                node_type.set_metadata(ogn.MetadataKeys.DESCRIPTION, "Ackermann Steering Geometry")
